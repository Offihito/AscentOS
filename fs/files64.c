...
// ================================================================
#define TEST_ELF_SIZE 293
static const uint8_t test_elf_binary[TEST_ELF_SIZE] = {
    /* ELF header (64 bytes) */
    0x7F, 0x45, 0x4C, 0x46, 0x02, 0x01, 0x01, 0x00,  /* magic, ELF64, LE, v1  */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* OS/ABI = SysV          */
    0x02, 0x00, 0x3E, 0x00, 0x01, 0x00, 0x00, 0x00,  /* ET_EXEC, x86-64, v1   */
    0x78, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,  /* e_entry = 0x400078    */
    0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* e_phoff = 64          */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* e_shoff = 0           */
    0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x38, 0x00,  /* flags=0, ehsz=64, phentsize=56 */
    0x01, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,  /* phnum=1, shentsize=64, shnum=0 */
    /* Program header (56 bytes) — PT_LOAD, R|X, offset=0 */
    0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,  /* p_type=LOAD, p_flags=R|X */
    ...
    0x25, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* p_filesz = 293        */
    0x25, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* p_memsz  = 293        */
    0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* p_align  = 0x1000     */
    /* .text: print "Hello from ELF!\r\n" to COM1 (0x3F8), then hlt+jmp$ */
    /* Each char: mov al,<c>; .w: in al,0x3FD; test al,0x20; jz .w; out 0x3F8,al */
    0xB0, 0x48, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'H' */
    0xB0, 0x65, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'e' */
    0xB0, 0x6C, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'l' */
    0xB0, 0x6C, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'l' */
    0xB0, 0x6F, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'o' */
    0xB0, 0x20, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* ' ' */
    0xB0, 0x66, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'f' */
    0xB0, 0x72, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'r' */
    0xB0, 0x6F, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'o' */
    0xB0, 0x6D, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'm' */
    0xB0, 0x20, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* ' ' */
    0xB0, 0x45, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'E' */
    0xB0, 0x4C, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'L' */
    0xB0, 0x46, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* 'F' */
    0xB0, 0x21, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* '!' */
    0xB0, 0x0D, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* '\r' */
    0xB0, 0x0A, 0xE4, 0xFD, 0xA8, 0x20, 0x74, 0xFA, 0xE6, 0xF8, /* '\n' */
    0xF4,               /* hlt                                    */
