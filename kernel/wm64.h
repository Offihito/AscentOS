...
#define COLOR_WINDOW_BASE       RGB(192, 192, 192)  
#define COLOR_WINDOW_FRAME      RGB(212, 208, 200)  
#define COLOR_TITLE_ACTIVE      RGB(0, 0, 168)      
#define COLOR_TITLE_INACTIVE    RGB(128, 128, 128)  
#define COLOR_TITLE_TEXT        RGB(255, 255, 255) 
#define COLOR_BUTTON_FACE       RGB(192, 192, 192)  
#define COLOR_BUTTON_SHADOW     RGB(128, 128, 128)  
#define COLOR_BUTTON_HILIGHT    RGB(255, 255, 255)  
#define COLOR_BUTTON_LIGHT      RGB(223, 223, 223)  
#define COLOR_BORDER_DARK       RGB(64, 64, 64)     
#define COLOR_BORDER_LIGHT      RGB(255, 255, 255)  
#define COLOR_CONTENT_BG        RGB(255, 255, 255) 
